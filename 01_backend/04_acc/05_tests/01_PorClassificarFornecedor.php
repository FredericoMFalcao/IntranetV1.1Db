...
->addTest(
	...
	->expectQuery('
		CALL DOC_DocumentosCriar ("{\"DocTipo\": \"FaturaFornecedor\", \"FileId\": \"ficheiroinexistente.pdf\"}");
	')
	->toErrWithCode("23000")
)
->addTest(
	...
	->expectQuery('
		...
		CALL DOC_DocumentosCriar ("{\"DocTipo\": \"FaturaFornecedor\", \"FileId\": \"fatura123.pdf\"}");
	')
	->toSucceed()
)
->addTest(
...
->addTest(
	...
	->expectQuery('
		CALL DOC_DocumentoAprovar (1, "{\"NumSerie\": \"FTAn12#123.pdf\", \"ClassificacaoAnalitica\": [{\"CentroResultados\": \"CR0101\", \"Analitica\": \"AN0202\", \"Colaborador\": \"CO123\", \"Valor\": 800}, {\"CentroResultados\": \"CR0101\", \"Analitica\": \"AN0202\", \"Colaborador\": \"CO456\", \"Valor\": 200}]}");
	')
	->toSucceed()
)
->addTest(
	...
	->expectQuery('
		CALL DOC_DocumentoAprovar (1, NULL);
	')
	->toSucceed()
)
->addTest(
	...
	->expectQuery('
		...
		CALL DOC_DocumentosCriar ("{\"DocTipo\": \"ComprovativoPagamento\", \"FileId\": \"cpagamento123.pdf\", \"NumSerie\": \"FTAn12#456.pdf\", \"ContaBancaria\": \"CB01\"}");
		CALL DOC_DocumentoAprovar (1, "{\"ComprovativoPagamentoId\": 2}");
	')
	->toSucceed()
)
->addTest(
